...
const socialIcons = {
  ...
  twitter: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.727-8.826-8.151-10.674H8.08l4.253 5.626z" /></svg>,
        ...
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-xs text-white">
          ...
          <div className="flex gap-4 mt-3 md:mt-0">
            {visibleSocialEntries.map(([key, data]) => {
              ...
              // Normalize email key: the config may store it as "email" with a mailto: url
              ...
              return (
                <a key={key} href={href} target={key === 'email' ? '_self' : '_blank'} rel="noopener noreferrer"
                  className="text-white hover:text-white/80 transition-colors" aria-label={key}>
